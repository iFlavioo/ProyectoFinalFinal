...
public class DespachoController {
    ...
    public DespachoDTO crear(@Valid @RequestBody DespachoDTO dto) {
    ...
    public ResponseEntity<DespachoDTO> actualizar(@PathVariable Long id, @Valid @RequestBody DespachoDTO dto) {
